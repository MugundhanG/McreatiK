...
export const TECH_TARGET_INDUSTRIES = [
  {
    ...
    tagline: 'Websites that build trust before the first appointment.',
    features: ['Treatments', 'Doctors', 'Reviews', 'WhatsApp'],
  },
  {
    icon: FiPlusCircle,
    title: 'Medical Clinics',
    description: 'Clear, trustworthy sites that present your specialities and make it simple for patients to reach you.',
    tagline: 'Clear, professional sites patients can rely on.',
    features: ['Specialities', 'Doctors', 'Timings', 'Enquiry Form'],
  },
  {
    icon: FiCoffee,
    title: 'Restaurants & Cafés',
    description: 'Menus, ambience and location made easy to find, so hungry customers choose you first.',
    tagline: 'Menus and ambience that get you chosen first.',
  ...
  },
  {
    ...
    tagline: 'Let clients browse and book before they walk in.',
    features: ['Services', 'Pricing', 'Gallery', 'WhatsApp'],
  },
  {
    icon: FiCamera,
    title: 'Photography Studios',
    description: 'A polished portfolio site that does justice to the work you already deliver.',
    tagline: 'A portfolio that does justice to your work.',
    features: ['Portfolio', 'Packages', 'Gallery', 'Enquiry Form'],
  },
  {
    icon: FiHeart,
    title: 'Gyms & Fitness Centers',
    description: 'Show off your space, trainers and plans in a way that turns browsers into members.',
    tagline: 'Turn browsers into members with a strong first look.',
    features: ['Plans', 'Trainers', 'Gallery', 'Schedule'],
  },
  {
    icon: FiShoppingBag,
    title: 'Retail Businesses',
    description: 'Put your products and store details online, where local shoppers are already looking.',
    tagline: 'Put your products where local shoppers are looking.',
    features: ['Catalogue', 'Store Info', 'WhatsApp', 'Offers'],
  },
  {
    icon: FiBriefcase,
    title: 'Professional Services',
    description: 'Build the credibility clients expect to see before they pick up the phone.',
    tagline: 'Build the credibility clients expect before they call.',
    features: ['Services', 'Case Studies', 'Testimonials', 'Contact Form'],
  },
  {
    icon: FiHome,
    title: 'Local Businesses',
    description: "Whatever you run, a clear, modern website makes it easier for customers to find and trust you.",
    tagline: 'A clear, modern site that earns customer trust.',
    features: ['About', 'Services', 'Reviews', 'Contact'],
  },
]
